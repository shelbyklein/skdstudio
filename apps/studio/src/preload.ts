...
const api: IpcApi = {
	...
	getProjects: () => ipcRendererInvoke( 'getProjects' ),
	showProjectContextMenu: ( context ) => ipcRendererSend( 'showProjectContextMenu', context ),
	createProject: ( name ) => ipcRendererInvoke( 'createProject', name ),
	renameProject: ( projectId, name ) => ipcRendererInvoke( 'renameProject', projectId, name ),
	deleteProject: ( projectId ) => ipcRendererInvoke( 'deleteProject', projectId ),
	setProjectCollapsed: ( projectId, collapsed ) =>
		ipcRendererInvoke( 'setProjectCollapsed', projectId, collapsed ),
	updateProjectsSortOrder: ( updates ) => ipcRendererInvoke( 'updateProjectsSortOrder', updates ),
	setSiteProject: ( siteId, projectId ) => ipcRendererInvoke( 'setSiteProject', siteId, projectId ),
